...
function submit() {
  router.post('/administracion/user', {
    name: name.value,
    email: email.value,
...
<template>
  ...
  <AppLayout>
    <div class="w-full px-8 py-10">
      <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-10">Crear Usuario</h1>
      ...
      <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          <label for="password" class="block text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Contraseña</label>
          <input
            id="password"
            v-model="password"
            type="password"
